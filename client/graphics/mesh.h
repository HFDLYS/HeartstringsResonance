...
class Mesh {
   public:
    // 特殊函数重载（三）
    Mesh(QOpenGLFunctions_3_3_Core *gl_functions, std::vector<Vertex> vertices, std::vector<unsigned int> indices,
    ...
    // getter & setter
    QOpenGLFunctions_3_3_Core *gl_functions() const;
    void set_gl_functions(QOpenGLFunctions_3_3_Core *gl_functions);
   ...
   private:
    QOpenGLFunctions_3_3_Core *gl_functions_;  // opengl函数指针
