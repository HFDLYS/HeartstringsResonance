...
Mesh::Mesh(QOpenGLFunctions_3_3_Core *gl_functions, std::vector<Vertex> vertices, std::vector<unsigned int> indices,
...
QOpenGLFunctions_3_3_Core *Mesh::gl_functions() const { return gl_functions_; }

void Mesh::set_gl_functions(QOpenGLFunctions_3_3_Core *gl_functions) { gl_functions_ = gl_functions; }
